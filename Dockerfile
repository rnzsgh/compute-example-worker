...
RUN mkdir -p /go/src/github.com/compute-example-worker
WORKDIR /go/src/github.com/compute-example-worker
...
COPY --from=builder /go/src/github.com/compute-example-worker/main /main
